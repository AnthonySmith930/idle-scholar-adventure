...
const ITEM_ASSET_REGISTRY: Record<string, ImageSourcePropType> = {
  ...
  iron_armor: require('@/assets/images/items/weapons/iron_armor.svg'),
  steel_armor: require('@/assets/images/items/weapons/steel_armor.svg'),
  mithril_armor: require('@/assets/images/items/weapons/mithril_armor.svg'),
  adamant_armor: require('@/assets/images/items/weapons/adamant_armor.svg'),
  dragonsteel_armor: require('@/assets/images/items/weapons/dragonsteel_armor.svg'),
  ...
  celestial_robes: require('@/assets/images/items/armor/celectial_robes.svg'),
  starter_armor_rogue: require('@/assets/images/items/armor/starter_armor_rogue.svg'),
  leather_cloak: require('@/assets/images/items/armor/leather_vest.svg'),
  shadow_leather_cloak: require('@/assets/images/items/armor/shadow_leather_vest.svg'),
